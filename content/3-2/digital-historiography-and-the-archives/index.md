+++
title = "Digital Historiography and the Archives"
slug = "digital-historiography-and-the-archives"
type = "article"
date = 2014-06-01
issue = "3-2"
volume = 3
...
section_weight = 3
weight = 1
authors = ["Katharina Hering", "Michael J. Kramer", "Joshua Sternfeld", "Kate Theimer"]
author_ids = ["katharina-hering", "michael-kramer", "joshua-sternfeld", "ktheimer"]
author = ["katharina-hering", "michael-kramer", "joshua-sternfeld", "ktheimer"]
+++

The following pieces by Joshua Sternfeld, Katharina Hering, Kate Theimer, and Michael Kramer are based on our session at the American Historical Association (AHA) meeting in 2014, “Digital Historiography and the Archives,” and the series of blog posts based on our presentations that we posted on Michael Kramer’s blog, [Issues in Digital History](http://blog.historians.org/2014/01/digital-historiography-archives/ "Digital Historiography and the Archives"), and cross-posted on [AHA Today](http://blog.historians.org/2014/01/digital-historiography-archives/ "Digital Historiography and the Archives").[^1] We are thrilled that _JDH_ invited us to submit our blog posts for publication. We had conceptualized the session as an interdisciplinary roundtable discussion with short presentations by each panelist, followed by a rich and multifaceted discussion with the audience.

[![AHA 2014 Roundtable Discussion: Digital Historiography and the Archives](/wp-content/uploads/2014/08/img_introduction_digital_historiography_roundtable.jpg)](/wp-content/uploads/2014/08/img_introduction_digital_historiography_roundtable.jpg)Expanding upon this format and our engaged in-person discussion, we had hoped that the series of linked blog posts would serve as a virtual, extended roundtable. Because it exists in the liminal, intermediary space between traditional conference session and formal publication, we imagined it as an experiment in new forms of “open source” scholarly communication. In sharing our work in provisional form, we hoped to encourage readers to continue this discussion on the blog. While we are publishing the discussion papers in _JDH_ in a more traditional format, the original idea behind the roundtable remains unchanged, and the [blog](http://blog.historians.org/2014/01/digital-historiography-archives/ "Digital Historiography and the Archives") continues to offer a space for posting criticisms, comments, ideas, and reflections.

### Introduction

The preservation, analysis, and representation of digital information in digital collections, archives, and other media poses complex, challenging, and often confusing issues for historical researchers, archivists, digital humanists, and librarians alike. Whether we even call these digital materials “archive” is at stake. We hoped to address some of these issues in the session and subsequent blog posts, while also discussing some of the elements of a framework or vocabulary that can support a critical appraisal of digital information. In his 2011 article in _[The American Archivist](http://archivists.metapress.com/content/644851p6gmg432h0/?p=4670ffbd61ee488e9ddd8ba76db04265&pi=7)_, panelist Joshua Sternfeld introduced such a framework called _digital historiography_, which he defined as the “critical, interdisciplinary study of the interaction of digital technology with historical practice.”  The AHA panel was originally organized, in part, as a response to that work.
...
We hope that sharing materials from the roundtable on the blog and now in _JDH_, even in provisional form, will continue to provide a catalyst for sustained discussion.

Originally published by Katharina Hering, Michael J. Kramer, Joshua Sternfeld, and Kate Theimer on [January 21, 2014](http://blog.historians.org/2014/01/digital-historiography-archives/ "Digital Historiography and the Archives").  Revised for _Journal of Digital Humanities_ in August 2014.

[^1]: The authors wish to thank Vanessa Varin from the AHA for cross-posting our pieces on _AHA Today_.
